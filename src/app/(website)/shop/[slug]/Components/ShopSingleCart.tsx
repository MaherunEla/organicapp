  ...
  return (
    <div className="container flex flex-col  items-center justify-center pt-[48px] xl:pt-[133px]">
      <div className="flex flex-col xl:flex-row  items-center justify-center gap-[28px] xl:gap-[43px]">
        <div
          style={{
            background: `url(${product?.productgallery}) no-repeat  `,
        ...
        <div className="w-full xl:max-w-[658px]">
          ...
          <div className="flex gap-[7px] pb-[27px]">
            ...
            <p className="font-bold">${product.discountprice.toFixed(2)}</p>
          </div>
          ...
          <div className="flex flex-col xl:flex-row xl:items-center gap-5 pt-[35px]">
            ...
            <div className="flex gap-5">
              <h6 className="w-[134px] h-[80px] flex items-center justify-center border border-sea_green rounded-[16px] text-[20px] font-bold">
                1
              </h6>
              <div className="px-[20px] py-[15px] lg:px-[39px] lg:py-[28px] bg-sea_green rounded-2xl ">
                <button
                  onClick={() => {
                    dispatch(addCart(productt));
                  }}
                  className="flex items-center justify-center gap-1 font-roboto text-base lg:text-[20px] font-bold  text-white"
                >
                  Add to Cart
      ...
      <div className="flex flex-col xl:flex-row pt-[72px] gap-5">
        <h6 className="py-[23px] px-[57px] rounded-[16px] border border-sea_green bg-sea_green font-open_sen text-white font-semibold">
          Product Description
        </h6>
        <h6 className="py-[23px] px-[57px] rounded-[16px] border border-very_light_green bg-very_light_green font-open_sen text-sea_green font-semibold">
          Product Description
        </h6>
      </div>
      <p className="pt-[27px] text-center max-w-[1137px]">
      ...
      <div className="pt-[40px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 ">
        {RelatedProduct.map((item, index) => (
          <div
            className=" w-[335px] pb-[17px]  bg-cream rounded-[30px]"
            key={index}
          >
