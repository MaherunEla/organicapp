        ...
        <div className='pt-[40px] xl:pt-[78px]'>
            ...
            <div className='pb-[28px] flex flex-col xl:flex-row gap-5'>
                ...
                <div className='px-[15px] py-[18px] xl:px-[45px] xl:py-[63px] bg-cream rounded-[20px]'>
                    <h6>Why Organic</h6>
                    <p className='w-full xl:w-[447px]'>Sed ut perspiciatis unde omnis iste natus error sit voluptat. page editors now use Lorem Ipsum as their default model text, and auncover.</p>
            ...
            <div className='flex flex-col xl:flex-row gap-5'>
                ...
                <div className='px-[45px] py-[63px] bg-cream rounded-[20px]'>
                    ...
                    <p className='xl:w-[447px]'>Sed ut perspiciatis unde omnis iste natus error sit voluptat. page editors now use Lorem Ipsum as their default model text, and auncover.</p>
            ...
            <div className='flex flex-col xl:flex-row gap-[28px] pt-[59px]'>
