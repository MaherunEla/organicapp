...
const Navbar = (props:{title:string; subtitle:string}) => {
  return (
    <div className=' pt-[60px] pb-[70px] flex items-center '>
        ...
        <div className='w-full xl:w-[600px] mr-[300px]'>
            <form>
                <button className='p-5'><SlMagnifier size={18}/></button>
        ...
        <div className='flex items-end gap-4 h-14 '>
            <span className='font-semibold text-[#222] uppercase'>view your store</span>
