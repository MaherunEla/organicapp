...
const HomeOrganic = () => {
  ...
  return (
    <div>
        <div className='flex'>
            ...
            <div>
                <div className=' my-[104px] w-[789px] h-[723px] px-[89px] py-[78px] bg-white border border-white rounded-[30px] '>
                    ...
                    <p className='pb-[35px] text-dark_gray'>Sed ut perspiciatis unde omnis iste natus error sit voluptat accusantium doloremque laudantium. Sed ut perspiciatis.</p>
        ...
        <div className='container flex flex-col items-center justify-center pt-[177px]'>
            <div className='sb flex justify-between'>
            <div>
            <h4 className='yellow'>News</h4>
            <h2 className='max-w-[702px]'>Discover weekly content about organic food, & more</h2>
            </div>
